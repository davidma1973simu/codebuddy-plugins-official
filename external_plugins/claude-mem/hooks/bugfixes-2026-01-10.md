...
### #646 - Plugin bricks CodeBuddy Code - stdin fstat EINVAL crash
- **Impact**: Plugin completely bricks CodeBuddy Code on Linux. Users cannot recover without manual config editing.
...
### #641/#609 - CODEBUDDY.md files in subdirectories
- **Impact**: CODEBUDDY.md files scattered throughout project directories
...
### #632 - Feature request for disabling CODEBUDDY.md in subdirectories
...
- CodeBuddy Code 2.1.1 compatibility + path validation (#614)
